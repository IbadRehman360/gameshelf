          ...
          <div className="mx-auto  border-b-[1px] border-gray-500 shadow-sm px-2 sm:px-2 bg-[#3b404e]   lg:px-3 xl:px-5 ">
            <div className="flex h-16 md:h-[70px] xl:h-[90px] justify-between  sm:mx-6 mx-4 ">
              ...
              {session ? (
                ...
                <NavLink
                  className=" bg-gray-50 mt-1 hover:bg-gray-100 opacity-95 active:bg-gray-400 text-black font-medium hover:shadow-md shadow text-[1.05rem] px-9 py-[6px]  rounded-full  outline-none focus:outline-none  ease-linear transition-all duration-150"
                  type="button"
                  to={"/sell"}
                >
                  Sell
                ...
                <NavLink
                  className="  bg-rose-500 hover:opacity-95 hover:bg-rose-500 mt-1 active:bg-gray-400  font-medium hover:shadow-md shadow text-[0.95rem]  text-gray-50 py-2 px-5  rounded-full  outline-none focus:outline-none  ease-linear transition-all duration-150"
                  type="button"
                  to={"/login"}
                >
                  Login / Sign up
