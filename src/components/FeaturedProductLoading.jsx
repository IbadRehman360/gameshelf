    ...
    <>
      <div className="flex flex-col rounded-2xl border-2 bg-[#fdfdfd] p-3 lg:p-4">
        ...
        <div className="m-3 my-1 flex items-center text-[0.4rem] sm:text-[0.7rem]">
          <div
            className="mt-1.5 h-8 w-8 animate-pulse rounded-full bg-slate-400 sm:h-8 sm:w-8 lg:h-9 lg:w-9"
          ></div>
          <div className="ml-2 inline-flex flex-1 items-center justify-between">
            <div className="mt-1 md:mt-2 lg:mt-0.5">
              ...
              <p className="h-4 w-14 animate-pulse bg-slate-400">
              </p>
            </div>
            <div className="mt-3 h-6 w-16 animate-pulse bg-slate-400">
            </div>
          </div>
        </div>
      </div>
