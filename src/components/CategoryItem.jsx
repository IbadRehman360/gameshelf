export default function categoryItem({ category, index }) {
  return (
    <div className="text-center h-12 w-12 lg:h-16 md:w-14 xl:h-24 md:mt-2.5 md:mb-4 lg:mb-0   xl:w-[72px] flex flex-col items-center gap-2">
      <div
        className={`${category.color} p-[0.7rem] xl:p-4 rounded-xl xl:rounded-3xl`}
      >
        <img
