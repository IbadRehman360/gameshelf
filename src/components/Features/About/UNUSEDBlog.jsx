  ...
  return (
    <div id="blog" className="py-12">
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        {/* Article 1 */}
        <div className="group p-6 sm:p-8 rounded-3xl bg-white border border-gray-100 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl hover:shadow-gray-600/10">
