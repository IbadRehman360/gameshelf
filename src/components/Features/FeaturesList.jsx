...
export default function FeaturesList() {
  return (
    <section className="relative  sm:py-2 xl-2 my-1  grid grid-cols-[repeat(2,_40%)] justify-around  lg:my-2 xl:my-4 sm:justify-center sm:grid-cols-[repeat(4,_24%)] 2xl:max-w-[90%] 2xl:mx-auto  ">
