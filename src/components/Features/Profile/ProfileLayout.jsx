      ...
      <section className=" bg-blueGray-200">
        <div className=" mx-auto  md:px-4">
          <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-16">
            <div className="px-6">
              <div className="flex flex-wrap justify-center md:justify-between lg:justify-around md:flex-nowrap lg:flex-wrap mb-4 md:mb-8">
                ...
                <div className="md:flex hidden">
                  Hey, dude! Mistake here. I wanted to lyk :3
                </div>
                ...
                <div className="mt-16 order-0 md:order-1 lg:order-1 text-center md:mt-0 my-4">
                  <div className="w-full mb-3 px-4 lg:order-2 flex justify-center">
