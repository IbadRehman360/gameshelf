...
export default function CategoryList() {
  return (
    <div className="mx-auto bg-gradient-to-b bg-white  border-2">
      <h3 className="block justify-center md:mt-8 mt-6 text-center text-1xl  text-gray-700 md:mb-4 mb-2 lg:text-[1.7rem] 3xl:text-[1.8rem]  md:text-[1.7rem] text-[1.4rem]  ml-2  font-semibold ">
        EXPLORE CATEGORIES
      </h3>
