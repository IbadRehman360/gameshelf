        ...
        <div className="flex flex-col p-3 lg:p-4 flex-co border-2 bg-[#fdfdfd] rounded-2xl  ">
            ...
            <div className="sm:text-[0.7rem] mb-1 text-[0.4rem] mt-1 sm-3    flex">
                ...
                <div className="inline-flex justify-between items-center ml-2 flex-1">
                    ...
                    <div className="mt-3">
                        <p className=" text-slate-600 mb-2 lg:text-[0.96rem]  sm:flex hidden md:text-[0.9rem] xl:text-[0.95rem]  sm:text-[0.9rem] text-[1rem]   font-medium">
                            {decimalConversion}
                            <span className="text-gray-800 md:text-[0.6rem] xl:text-[0.6rem] sm:text-[0.55rem] lg:ml-1 xl:mt-[4.2px] lg:mt-[2px]   sm:mt-[2px] md:mt-[1px] ml-[1px] sm:ml-[3px]  sm:text-sm text-[0.5rem] font-meduim">
                                USD
                            </span>
                        </p>
                    </div>
