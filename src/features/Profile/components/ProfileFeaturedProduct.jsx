        ...
        <div className="flex flex-col rounded-2xl border-2 bg-[#fdfdfd] p-3 lg:p-4">
            ...
            <div className="m-3 my-1 flex text-[0.4rem] sm:text-[0.7rem]">
                ...
                <div className="ml-2 inline-flex flex-1 items-center justify-between">
                    ...
                    <div className="mt-3">
                        <p className="mb-2 hidden text-[1rem] font-medium text-slate-600 sm:flex sm:text-[0.9rem] md:text-[0.9rem] lg:text-[0.96rem] xl:text-[0.95rem]">
                            {decimalConversion}
                            <span className="ml-[1px] text-[0.5rem] text-gray-800 sm:ml-[3px] sm:mt-[2px] sm:text-[0.55rem] md:mt-[1px] md:text-[0.6rem] lg:ml-1 lg:mt-[2px] xl:mt-[4.2px] xl:text-[0.6rem]">
                                USD
                            </span>
                        </p>
                    </div>
