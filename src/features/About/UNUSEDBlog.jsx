  ...
  return (
    <div id="blog" className="py-12">
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        {/* Article 1 */}
        <div className="group rounded-3xl border border-gray-100 bg-white p-6 shadow-2xl hover:shadow-gray-600/10 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none sm:p-8">
