...
function Chat({ chat, index }) {
  return (
    <div className="relative flex flex-row">
      <div className="absolute right-0 top-0 text-xs text-gray-500">{moment(chat.lastMessage.created_at).fromNow()}</div>
      ...
      <div className="ml-3 flex grow flex-col text-start">
        <div className="text-sm font-medium capitalize">{chat.users.username} </div>
